...
public class LanState extends SavedData {
    ...
    // NBTから読み込み
    public static LanState fromNbt(CompoundTag nbt, HolderLookup.Provider registries) {
    ...
    // Factoryを作成
    public static SavedData.Factory<LanState> factory() {
        return new SavedData.Factory<>(LanState::new, LanState::fromNbt, DataFixTypes.LEVEL);
    }
