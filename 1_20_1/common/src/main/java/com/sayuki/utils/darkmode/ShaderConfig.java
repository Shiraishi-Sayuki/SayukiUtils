...
public class ShaderConfig {
    ...
    public ShaderConfig() {
        ...
        this.version = 2;
        ResourceLocation tex_shader_location = new ResourceLocation("sayukiutils", "dark_position_tex");
        ResourceLocation tex_color_shader_location = new ResourceLocation("sayukiutils", "dark_position_tex_color");
